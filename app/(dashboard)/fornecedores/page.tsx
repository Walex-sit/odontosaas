  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="text-slate-505 mt-1 text-sm">Cadastro de fornecedores e parceiros</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-slate-100 flex items-center gap-2">
          ...
          <h3 className="text-lg font-bold text-slate-800">Fornecedores Cadastrados</h3>
        </div>
        ...
        {carregando ? (
          ...
          <div className="text-center py-16 px-4">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-1">Nenhum fornecedor cadastrado</h3>
            <p className="text-slate-505 text-sm">Adicione seu primeiro fornecedor acima.</p>
          </div>
        ) : (
              ...
              <tbody className="divide-y divide-slate-100">
                {fornecedores.map((f) => (
                  <tr key={f.id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap font-bold text-slate-800 text-sm">{f.nome}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">{f.cnpj || '—'}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">{f.telefone || '—'}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">{f.email || '—'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
