    ...
    <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-8 z-10 relative">
      <div className="flex-1 max-w-2xl">
        <div className="relative group">
          ...
          <input
            type="text"
            className="block w-full pl-11 pr-4 py-2.5 border border-gray-200 rounded-full text-sm placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50/50 hover:bg-white transition-all text-gray-900"
      ...
      <div className="flex items-center gap-6 ml-6">
        <button className="hidden sm:flex bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-sm transition-colors items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden md:block">
            <p className="text-sm font-bold text-gray-900">Dr. Administrador</p>
            <p className="text-xs font-medium text-gray-500">CRO 12345</p>
          </div>
